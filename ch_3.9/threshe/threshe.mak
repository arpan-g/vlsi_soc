...
!IF "$(CFG)" == ""
CFG=threshe - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to threshe - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "threshe - Win32 Release" && "$(CFG)" !=\
 "threshe - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "threshe.mak" CFG="threshe - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "threshe - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "threshe - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "threshe - Win32 Debug"
CPP=cl.exe
RSC=rc.exe

!IF  "$(CFG)" == "threshe - Win32 Release"
...
ALL : "$(OUTDIR)\threshe.exe" "..\..\bindosr\threshe.exe"

CLEAN : 
	-@erase "..\..\bindosr\threshe.exe"
	-@erase ".\Release\threshe.exe"
	-@erase ".\Release\threshe.obj"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "..\..\libimage" /I\
 ...
 /Fp"$(INTDIR)/threshe.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/threshe.bsc" 
BSC32_SBRS=
LINK32=link.exe
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /subsystem:console /incremental:no /pdb:"$(OUTDIR)/threshe.pdb" /machine:I386\
 /out:"$(OUTDIR)/threshe.exe" 
LINK32_OBJS= \
	".\Release\threshe.obj"

"$(OUTDIR)\threshe.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
!ELSEIF  "$(CFG)" == "threshe - Win32 Debug"
...
ALL : "$(OUTDIR)\threshe.exe" "..\..\bindosd\threshe.exe"

CLEAN : 
	-@erase ".\Debug\vc40.pdb"
	-@erase ".\Debug\vc40.idb"
	-@erase ".\Debug\threshe.ilk"
	-@erase ".\Debug\threshe.obj"
	-@erase ".\Debug\threshe.pdb"
	-@erase "..\..\bindosd\threshe.exe"
	-@erase ".\Debug\threshe.exe"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /I "..\..\libimage" /I\
 ...
 /Fp"$(INTDIR)/threshe.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /subsystem:console /incremental:yes /pdb:"$(OUTDIR)/threshe.pdb" /debug\
 /machine:I386 /out:"$(OUTDIR)/threshe.exe" 
LINK32_OBJS= \
	".\Debug\threshe.obj"
...
# Name "threshe - Win32 Release"
# Name "threshe - Win32 Debug"
...
"$(INTDIR)\threshe.obj" : $(SOURCE) $(DEP_CPP_THRES) "$(INTDIR)"
