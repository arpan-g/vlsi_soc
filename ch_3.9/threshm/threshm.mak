...
!IF "$(CFG)" == ""
CFG=threshm - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to threshm - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "threshm - Win32 Release" && "$(CFG)" !=\
 "threshm - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "threshm.mak" CFG="threshm - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "threshm - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "threshm - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "threshm - Win32 Release"
RSC=rc.exe
CPP=cl.exe

!IF  "$(CFG)" == "threshm - Win32 Release"
...
ALL : "$(OUTDIR)\threshm.exe" "..\..\bindosr\threshm.exe"

CLEAN : 
	-@erase "..\..\bindosr\threshm.exe"
	-@erase ".\Release\threshm.exe"
	-@erase ".\Release\threshm.obj"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "." /I " ..\..\libtiff\libtiff" /I\
 ...
 /Fp"$(INTDIR)/threshm.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/threshm.bsc" 
BSC32_SBRS=
LINK32=link.exe
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /subsystem:console /incremental:no /pdb:"$(OUTDIR)/threshm.pdb" /machine:I386\
 /out:"$(OUTDIR)/threshm.exe" 
LINK32_OBJS= \
	"$(INTDIR)/threshm.obj"

"$(OUTDIR)\threshm.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
!ELSEIF  "$(CFG)" == "threshm - Win32 Debug"
...
ALL : "$(OUTDIR)\threshm.exe" "..\..\bindosd\threshm.exe"

CLEAN : 
	-@erase ".\Debug\vc40.pdb"
	-@erase ".\Debug\vc40.idb"
	-@erase ".\Debug\threshm.ilk"
	-@erase ".\Debug\threshm.obj"
	-@erase ".\Debug\threshm.pdb"
	-@erase "..\..\bindosd\threshm.exe"
	-@erase ".\Debug\threshm.exe"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /I "." /I " ..\..\libtiff\libtiff" /I\
 ...
 /Fp"$(INTDIR)/threshm.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /subsystem:console /incremental:yes /pdb:"$(OUTDIR)/threshm.pdb" /debug\
 /machine:I386 /out:"$(OUTDIR)/threshm.exe" 
LINK32_OBJS= \
	"$(INTDIR)/threshm.obj"
...
# Name "threshm - Win32 Release"
# Name "threshm - Win32 Debug"
...
"$(INTDIR)\threshm.obj" : $(SOURCE) $(DEP_CPP_THRES) "$(INTDIR)"
